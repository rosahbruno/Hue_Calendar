 ...
 *
 */
public class PHBulbActivity extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (lastIpAddress !=null && !lastIpAddress.equals("")) {
            ...
            if (!phHueSDK.isAccessPointConnected(lastAccessPoint)) {
                PHWizardAlertActivity.getInstance().showProgressDialog(R.string.connecting, PHBulbActivity.this);
    ...
    private PHSDKListener listener = new PHSDKListener() {
        ...
        public void onAuthenticationRequired(PHAccessPoint accessPoint) {
            ...
            startActivity(new Intent(PHBulbActivity.this, PHPushLinkActivity.class));

        }

        @Override
        public void onConnectionResumed(PHBridge bridge) {
            if (PHBulbActivity.this.isFinishing())
                return;
        ...
        public void onError(int code, final String message) {
            ...
            if (code == PHHueError.NO_CONNECTION) {
                ...
                PHWizardAlertActivity.getInstance().closeProgressDialog();
                PHBulbActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        PHWizardAlertActivity.showErrorDialog(PHBulbActivity.this, message, R.string.btn_ok);
                    }
                });
    ...
    public void doBridgeSearch() {
        PHWizardAlertActivity.getInstance().showProgressDialog(R.string.search_progress, PHBulbActivity.this);
        PHBridgeSearchManager sm = (PHBridgeSearchManager) phHueSDK.getSDKService(PHHueSDK.SEARCH_BRIDGE);
    ...
    public void startMainActivity() {
        Intent intent = new Intent(getApplicationContext(), LightBulbs.class);
