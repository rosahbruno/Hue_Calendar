...
import com.nillawaffer.hue.calendar.AccessPointListAdapter;
import com.nillawaffer.hue.calendar.HueSharedPreferences;
...
public class PHHomeActivity extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (lastIpAddress !=null && !lastIpAddress.equals("")) {
            ...
            if (!phHueSDK.isAccessPointConnected(lastAccessPoint)) {
                PHWizardAlertActivity.getInstance().showProgressDialog(R.string.connecting, PHHomeActivity.this);
        ...
        public void onError(int code, final String message) {
            ...
            if (code == PHHueError.NO_CONNECTION) {
                ...
                PHHomeActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        PHWizardAlertActivity.showErrorDialog(PHHomeActivity.this, message, R.string.btn_ok);
                    }
                });
    ...
    public void doBridgeSearch() {
        PHWizardAlertActivity.getInstance().showProgressDialog(R.string.search_progress, PHHomeActivity.this);
        PHBridgeSearchManager sm = (PHBridgeSearchManager) phHueSDK.getSDKService(PHHueSDK.SEARCH_BRIDGE);
